...
// isCtyunVideoModel 判断是否为天翼云 happyhorse 视频模型
// 这些模型价格固定（720P=0.99元/秒、1080P=1.79元/秒），会员/group 折扣不生效
func isCtyunVideoModel(modelName string) bool {
	return strings.HasPrefix(modelName, "happyhorse-1.0-")
}
...
func ModelPriceHelperPerCall(c *gin.Context, info *relaycommon.RelayInfo) (types.PriceData, error) {
	...
	// 天翼云视频模型价格固定，会员/group 折扣不生效
	if isCtyunVideoModel(info.OriginModelName) {
