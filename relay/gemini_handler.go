...
func GeminiHelper(c *gin.Context, info *relaycommon.RelayInfo) (FastTokenError *types.FastTokenError) {
...
func GeminiEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo) (FastTokenError *types.FastTokenError) {
	info.InitChannelMeta(c)
