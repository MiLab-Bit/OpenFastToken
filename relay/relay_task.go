...
import (
	...
	"www.abc-ai.cn/FastToken/relay/channel/task/taskcommon"
...
func ResolveOriginTask(c *gin.Context, info *relaycommon.RelayInfo) *dto.TaskError {
	...
	if originTask.ChannelId != info.ChannelId {
		key, _, FastTokenError := ch.GetNextEnabledKey()
		if FastTokenError != nil {
			return service.TaskErrorWrapper(FastTokenError, "channel_no_available_key", FastTokenError.StatusCode)
		}
...
func RelayTaskSubmit(c *gin.Context, info *relaycommon.RelayInfo) (*TaskSubmitResult, *dto.TaskError) {
	...
	c.Header("X-FastToken-Other-Ratios", string(ratiosJSON))
