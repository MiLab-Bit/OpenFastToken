...
import (
	...
	taskcommon "github.com/MiLab-Bit/OpenFastToken/relay/channel/task/taskcommon"
...
func (a *TaskAdaptor) BuildRequestURL(info *relaycommon.RelayInfo) (string, error) {
	...
	if isFastTokenRelay(info.ApiKey) {
...
func (a *TaskAdaptor) createJWTTokenWithKey(apiKey string) (string, error) {
	if isFastTokenRelay(apiKey) {
		return apiKey, nil // FastToken relay
	}
...
func isFastTokenRelay(apiKey string) bool {
