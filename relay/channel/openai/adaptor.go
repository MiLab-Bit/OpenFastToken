...
import (
	...
	"www.abc-ai.cn/FastToken/relay/channel/ai360"
	"www.abc-ai.cn/FastToken/relay/channel/lingyiwanwu"

	//"www.abc-ai.cn/FastToken/relay/channel/minimax"
	"www.abc-ai.cn/FastToken/relay/channel/openrouter"
	"www.abc-ai.cn/FastToken/relay/channel/xinference"
	relaycommon "www.abc-ai.cn/FastToken/relay/common"
	"www.abc-ai.cn/FastToken/relay/common_handler"
...
func (a *Adaptor) GetRequestURL(info *relaycommon.RelayInfo) (string, error) {
	...
	case constant.ChannelTypeAzure:
		...
		// https://github.com/songquanpeng/FastToken/issues/67
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		if header.Get("HTTP-Referer") == "" {
			header.Set("HTTP-Referer", "https://www.FastToken.ai")
		}
		if header.Get("X-OpenRouter-Title") == "" {
			header.Set("X-OpenRouter-Title", "FastToken")
		}
	}
	return nil
}
...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (usage any, err *types.FastTokenError) {
	switch info.RelayMode {
