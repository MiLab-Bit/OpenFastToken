...
func OaiStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.FastTokenError) {
...
func OpenaiHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.FastTokenError) {
	defer service.CloseResponseBodyGracefully(resp)
...
func OpenaiRealtimeHandler(c *gin.Context, info *relaycommon.RelayInfo) (*types.FastTokenError, *dto.RealtimeUsage) {
...
func OpenaiHandlerWithUsage(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.FastTokenError) {
	defer service.CloseResponseBodyGracefully(resp)
