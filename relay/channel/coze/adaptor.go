...
import (
	...
	"github.com/MiLab-Bit/OpenFastToken/relay/common"
...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *common.RelayInfo) (usage any, err *types.FastTokenError) {
	if info.IsStream {
