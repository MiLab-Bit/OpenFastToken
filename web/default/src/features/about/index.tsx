              ...
              <div className="bg-card rounded-2xl p-8 shadow-sm border border-border mb-8
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between py-3 border-b border-border">
                    ...
                    <a href="https://www.abc-ai.cn" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 dark:text-blue-400">
                      https://www.abc-ai.cn
                    </a>
                  </div>
                  <div className="flex justify-between py-3 border-b border-border">
                    <span className="text-muted-foreground">{t('about.brand.docsLabel')}</span>
                    <a href="https://www.abc-ai.cn/docs" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 dark:text-blue-400">
                      https://www.abc-ai.cn/docs
                    </a>
                  </div>
                  <div className="flex justify-between py-3 border-b border-border">
