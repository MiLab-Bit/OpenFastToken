...
const BASE_URL = 'https://www.abc-ai.cn'
...
client = OpenAI(
    base_url="https://www.abc-ai.cn/v1",
...
for chunk in stream:
    ...
    <div className="bg-card rounded-xl p-6 shadow-sm border border-stone-card">
      ...
      <div className="relative">
        <pre className="bg-stone-bg rounded-lg p-4 text-xs font-mono text-stone-text overflow-x-auto leading-relaxed">
{`curl https://www.abc-ai.cn/v1/chat/completions \\
  ...
  -d '{
    ...
    "messages": [{"role": "user", "content": "你好！"}]
        ...
        <div className="absolute top-2 right-2">
          <CopyButton
            value={`curl https://www.abc-ai.cn/v1/chat/completions \\\n  -H "Content-Type: application/json" \\\n  -H "Authorization: Bearer YOUR_API_KEY" \\\n  -d '{\\n    "model": "deepseek-v4-pro",\\n    "messages": [{"role": "user", "content": "你好！"}]\\n  }'`}
            variant="outline"
            className="border-stone-card bg-card size-7"
            iconClassName="size-3"
          />
  ...
  content: (
    <div className="space-y-4">
      {( [
        ...
        {
          q: '如何联系技术支持？',
          a: '通过控制台提交工单，或发送邮件至 abovetigers@qq.com。工作日 9:00-18:00 提供技术支持。',
        },
      ...
      <div className="space-y-6">
        ...
        <div className="bg-card rounded-xl p-6 shadow-sm border border-stone-card">
          ...
          <div className="relative">
            <pre className="bg-stone-bg rounded-lg p-4 text-xs font-mono text-stone-text overflow-x-auto leading-relaxed">
{`# macOS / Linux
curl -fsSL https://www.abc-ai.cn/skills/install-fasttoken-skills.py -o install.py
python3 install.py

# Windows (PowerShell)
Invoke-WebRequest https://www.abc-ai.cn/skills/install-fasttoken-skills.py -OutFile install.py
python install.py`}
            </pre>
            <div className="absolute top-2 right-2">
              <CopyButton
                value={`curl -fsSL https://www.abc-ai.cn/skills/install-fasttoken-skills.py -o install.py\npython3 install.py`}
                variant="outline"
                className="border-stone-card bg-card size-7"
                iconClassName="size-3"
              />
