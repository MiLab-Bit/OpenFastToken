...
/** Midjourney (drawing) log status values */
export type MidjourneyLogStatus =
  | 'NOT_START'
  | 'SUBMITTED'
  | 'IN_PROGRESS'
  | 'SUCCESS'
...
export interface MidjourneyLog {
  ...
  properties?: string
  image_url?: string
  status: MidjourneyLogStatus // NOT_START, SUBMITTED, IN_PROGRESS, SUCCESS, FAILURE, MODAL
  other?: string
  created_at?: number
  updated_at?: number
}
...
export interface TaskLog {
  ...
  fail_reason?: string
  status: TaskLogStatus // NOT_START, SUBMITTED, IN_PROGRESS, SUCCESS, FAILURE, QUEUED, UNKNOWN
  other?: string
  created_at?: number
  updated_at?: number
}
