...
export function CommonLogsFilterBar<TData>(
  ...
  const applyWithType = useCallback(
    (type: LogTypeValue, filterState: CommonLogFilters) => {
      const filterParams = buildSearchParams(filterState, 'common')
      navigate({
        ...
        onValueChange={(value) => {
          const nextLogType =
            value !== null && isLogTypeValue(value)
              ...
              : LOG_TYPE_ALL_VALUE
          setLogType(nextLogType)
          applyWithType(nextLogType, filters)
        }}
      >
        <SelectTrigger>
