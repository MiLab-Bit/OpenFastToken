...
export function usePricingColumns(
  ...
  // Show discount badge in recharge mode when membership has a discount
  const showDiscountBadge = showRechargePrice && !!membershipDiscountLabel
        ...
        if (isTokenBased) {
          ...
          return (
            <div className='min-w-[160px]'>
              ...
              {showDiscountBadge && !isVideoTieredModel(model) && (
