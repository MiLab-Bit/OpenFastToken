...
import { listSystemTasks } from '@/features/system-info/api'
import type {
  SystemTask,
  SystemTaskStatus,
      ...
      <Table className='min-w-[900px]'>
        ...
        <TableBody>
          {props.tasks.map((task) => {
            ...
            return (
              <TableRow key={String(task.task_id)} className='hover:bg-muted/30'>
                ...
                <TableCell className='text-muted-foreground max-w-[280px] truncate py-3 align-middle font-mono text-xs'>
                  {typeof task.locked_by === 'string' ? task.locked_by : '-'}
                </TableCell>
                <TableCell
                ...
                <TableCell
                  ...
                  title={typeof task.error === 'string' ? task.error : undefined}
                >
