...
export const WebPreviewUrl = ({
  ...
  // Use controlled value if provided, otherwise use context URL
  const inputValue = value ?? url

  // Sync context URL when controlled value changes externally
  useEffect(() => {
    if (value !== undefined && typeof value === 'string' && value !== url) {
      setUrl(value)
    }
  }, [value, url, setUrl])
