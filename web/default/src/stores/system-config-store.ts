...
import type { PromoConfig } from '@/features/home/components/promo-banner'
...
export interface SystemConfig {
  ...
  /** Optional promotional banner configuration */
...
export const DEFAULT_CURRENCY_CONFIG: CurrencyConfig = {
  ...
  quotaPerUnit: 500000,
  usdExchangeRate: 1, // 已废弃，固定为 1
  customCurrencySymbol: '元',
  customCurrencyExchangeRate: 1, // 已废弃，固定为 1
}
