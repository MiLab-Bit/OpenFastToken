...
const (
	...
	MsgUserRegisterSuccess           = "user.register_success"
...
const (
	MsgInvalidPhone             = "user.invalid_phone"
	MsgPhoneAlreadyRegistered   = "user.phone_already_registered"
	MsgPhoneNotRegistered       = "user.phone_not_registered"
	MsgInvalidSMSCode          = "user.invalid_sms_code"
	MsgSMSSent                  = "user.sms_sent"
	MsgSMSVerified             = "user.sms_verified"
	MsgPhoneBindSuccess         = "user.phone_bind_success"
	MsgPhoneUnbindSuccess       = "user.phone_unbind_success"
)

// WeChat binding messages
const (
	MsgWeChatNotAuthorized     = "user.wechat_not_authorized"
	MsgWeChatUserInfoInvalid    = "user.wechat_user_info_invalid"
	MsgWeChatOpenIDMissing      = "user.wechat_openid_missing"
	MsgWeChatAlreadyBound        = "user.wechat_already_bound"
	MsgWeChatBindSuccess         = "user.wechat_bind_success"
	MsgWeChatUnbindSuccess       = "user.wechat_unbind_success"
)

// Generic messages
const (
	MsgNotImplemented           = "common.not_implemented"
)
