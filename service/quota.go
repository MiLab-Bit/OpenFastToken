...
func PreWssConsumeQuota(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, usage *dto.RealtimeUsage) error {
	...
	// Apply DB-based group-model ratio if configured
	if dbGroupRatio := model.GetGroupRatio(relayInfo.UserGroup, modelName); dbGroupRatio != 0 {
		modelRatio = modelRatio * dbGroupRatio
	}
