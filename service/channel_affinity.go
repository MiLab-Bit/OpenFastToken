...
import (
	...
	"github.com/MiLab-Bit/OpenFastToken/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "FastToken:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "FastToken:channel_affinity_usage_cache_stats:v1"
)
