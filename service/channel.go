...
func DisableChannel(channelError types.ChannelError, reason string) {
	// 断路器：记录失败
	circuitbreaker.RecordFailure(int64(channelError.ChannelId))
...
func ShouldDisableChannel(err *types.FastTokenError) bool {
...
func ShouldEnableChannel(FastTokenError *types.FastTokenError, status int) bool {
