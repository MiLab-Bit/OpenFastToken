...
func TestMain(m *testing.M) {
	f, err := os.CreateTemp("", "fasttoken_service_*.db")
	if err != nil {
...
func makeTask(userId, channelId, quota, tokenId int, billingSource string, originModelPrice float64) *model.Task {
	return &model.Task{
