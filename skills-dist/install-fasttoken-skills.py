...
从 https://www.abc-ai.cn 下载 FastToken 技能压缩包并解压。

仅依赖 Python 标准库，跨平台（Windows / macOS / Linux）。

用法:
    python3 install-fasttoken-skills.py
    python3 install-fasttoken-skills.py --url https://www.abc-ai.cn/skills/fasttoken-skills.zip
...
DEFAULT_URL = "https://www.abc-ai.cn/skills/fasttoken-skills.zip"
