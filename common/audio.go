...
import (
	...
	// "github.com/abema/go-mp4" // TEMPORARY DISABLED
...
func getM4ADuration(r io.ReadSeeker) (float64, error) {
	// MP4 parsing is temporarily disabled (missing go-mp4 dependency)
	return 0, fmt.Errorf("MP4 parsing is temporarily disabled")
}
