...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.FastTokenError {
	...
	key, index, FastTokenError := channel.GetNextEnabledKey()
