...
import (
	...
	"github.com/MiLab-Bit/OpenFastToken/pkg/ionet"
...
func DeleteDeployment(c *gin.Context) {
	...
	data := gin.H{
		"status":        resp.Status,
		"deployment_id": resp.DeploymentID,
		"message":       i18n.Msg(c, "Deployment termination requested successfully"),
	}
	common.ApiSuccess(c, data)
}
...
func CreateDeployment(c *gin.Context) {
	...
	data := gin.H{
		"deployment_id": resp.DeploymentID,
		"status":        resp.Status,
		"message":       i18n.Msg(c, "Deployment created successfully"),
	}
	common.ApiSuccess(c, data)
}
