...
// https://github.com/songquanpeng/FastToken/issues/79
...
func UpdateChannelBalance(c *gin.Context) {
	...
	if channel.ChannelInfo.IsMultiKey {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": i18n.Msg(c, "多密钥渠道不支持余额查询"),
		})
		return
	}
...
func UpdateAllChannelBalances() error {
	channels, err := channelRepo().GetAll(0, -1, true, false)
	if err != nil {
		return err
	}
