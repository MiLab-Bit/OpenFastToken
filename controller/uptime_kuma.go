...
func GetUptimeKumaStatus(c *gin.Context) {
	...
	if len(groups) == 0 {
		c.JSON(http.StatusOK, gin.H{"success": true, "message": i18n.Msg(c, ""), "data": []UptimeGroupResult{}})
		return
	}
	...
	g.Wait()
	c.JSON(http.StatusOK, gin.H{"success": true, "message": i18n.Msg(c, ""), "data": results})
}
